...
public class CognitoTenantFilter extends OncePerRequestFilter {
    ...
    private final boolean multitenantModeSingleUserPoolEnabled;
    ...
    public CognitoTenantFilter(TenantExtractor tenantExtractor) {
        ...
        this.multitenantModeSingleUserPoolEnabled = DirigibleConfig.MULTI_TENANT_MODE_SINGLE_USER_POOL.getBooleanValue();
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (multitenantModeEnabled && multitenantModeSingleUserPoolEnabled) {
