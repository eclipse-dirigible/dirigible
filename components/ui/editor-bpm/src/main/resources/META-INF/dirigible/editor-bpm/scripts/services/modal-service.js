...
/**
 * Drop-in replacement for angular-strap's `$modal` factory using Bootstrap-3's
 * jQuery modal plugin. Same call signature as the angular-strap original:
 *   $modal({ template: '...html', scope: $scope }) -> { hide() }
 */
