...
@Table(name = "DIRIGIBLE_COMPONENTS")
public class Component extends Artefact {

    /** The Constant ARTEFACT_TYPE. */
    public static final String ARTEFACT_TYPE = "component";
    ...
    public String toString() {
        return "Component [id=" + id + ", location=" + location + ", name=" + name + ", type=" + type + ", description=" + description
