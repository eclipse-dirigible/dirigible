...
/**
 * Marks a client class as a singleton repository discoverable via {@code @Inject}. Repositories are
 ...
 * {@link org.eclipse.dirigible.engine.java.spi.DependencyResolver} so
 * {@code ControllerClassConsumer} can satisfy {@link Inject} field bindings.
 */
