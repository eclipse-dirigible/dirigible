...
public class ODataMapping extends Artefact {
    ...
    /** The content. */
    @Column(name = "ODATAM_CONTENT", columnDefinition = "TEXT", nullable = true)
    @Expose
     ...
     */
    public ODataMapping(String location, String name, String description, Set<String> dependencies, String content) {
    ...
    public String toString() {
        return "ODataMapping [id=" + id + ", content=" + content + ", location=" + location + ", name=" + name + ", type=" + type
