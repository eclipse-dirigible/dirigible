...
import { CustomerRepository, CustomerEntityOptions } from "../../dao/Customer/CustomerRepository";
...
class CustomerService {
    ...
    private validateEntity(entity: any): void {
        ...
        if (entity.Address?.length > 100) {
            throw new ValidationError(`The 'Address' exceeds the maximum length of [100] characters`);
        }
