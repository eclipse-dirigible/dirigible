...
import { CityRepository, CityEntityOptions } from "../../dao/Country/CityRepository";
...
class CityService {
    ...
    public getAll(_: any, ctx: any) {
        try {
            ...
            let Country = parseInt(ctx.queryParameters.Country);
            Country = isNaN(Country) ? ctx.queryParameters.Country : Country;
