 ...
 */
@Disabled("Redundant with DependsOnHarmoniaIT, which covers the same depends-on cascade; disabled to keep the integration-tests suite runtime under its CI cap")
