...
/**
 * A cron-triggered route invoking JavaScript in two steps carries the body through to the final log
 * step.
 */
public class CamelDirigibleTwoStepsJSInvokerCronRouteIT extends IntegrationTest {

    private static final String PROJECT = "CamelDirigibleTwoStepsJSInvokerCronRouteIT";
    ...
    void attachLogAsserter() {
        logsAsserter = new LogsAsserter("TwoStepsLogger", Level.INFO);
    }

    @Test
    void theRouteCompletesWithTheBodyItsHandlerSet() {
