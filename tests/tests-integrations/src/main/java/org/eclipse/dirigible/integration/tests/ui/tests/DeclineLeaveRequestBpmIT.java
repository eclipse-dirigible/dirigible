...
@Disabled("Same workflow as ApproveLeaveRequestBpmIT (opposite branch), with engine-level BPMN covered by JavaBpmnIT/BpmnModelApiIT; disabled to keep the integration-tests suite runtime under its CI cap")
