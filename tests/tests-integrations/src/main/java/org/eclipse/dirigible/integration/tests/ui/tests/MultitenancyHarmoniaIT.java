...
/**
 * Verifies per-tenant isolation with the entity application generated by
 * {@code template-application-ui-harmonia-java} (Java REST + Alpine/Harmonia SPA) instead of the
 * AngularJS/TypeScript full-stack.
 * <p>
