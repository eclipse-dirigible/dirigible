...
public class ContentTypeHelper {
    ...
    /** The Constant APPLICATION_JSON_NUMBERS - document-number series declarations. */
    public static final String APPLICATION_JSON_NUMBERS = "application/json+numbers";
    ...
    static {
        ...
        TEXT_CONTENT_TYPES.put("numbers", APPLICATION_JSON_NUMBERS); //$NON-NLS-1$
