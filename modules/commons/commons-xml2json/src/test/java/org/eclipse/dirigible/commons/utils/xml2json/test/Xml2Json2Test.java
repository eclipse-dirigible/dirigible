...
public class Xml2Json2Test {
    ...
    private void toJson(String xmlFile, String jsonFile) {
        try {
            String json = null;
            InputStream inXml = Xml2Json2Test.class.getResourceAsStream(xmlFile);
            try {
                @SuppressWarnings("deprecation")
                String xml = IOUtils.toString(inXml);
                json = Xml2Json2.toJson(xml);
            ...
            InputStream inJson = Xml2Json2Test.class.getResourceAsStream(jsonFile);
            try {
                @SuppressWarnings("deprecation")
    ...
    public void testToJsonBasic() {
        toJson("xml2json2/basic.xml", "xml2json2/basic.json");
    }
    ...
    public void testToJsonAttrs() {
        toJson("xml2json2/attrs.xml", "xml2json2/attrs.json");
    }
    ...
    public void testToJsonElementWithAttrs() {
        toJson("xml2json2/element_attrs.xml", "xml2json2/element_attrs.json");
    }
    ...
    public void testToJsonElementWithAttrsMultiple() {
        toJson("xml2json2/element_attrs_multiple.xml", "xml2json2/element_attrs_multiple.json");
    }
    ...
    public void testToJsonCData() {
        toJson("xml2json2/cdata.xml", "xml2json2/cdata.json");
    }
    ...
    public void testToJsonCDataAttrs() {
        toJson("xml2json2/cdata_attrs.xml", "xml2json2/cdata_attrs.json");
    }
    ...
    public void testToJsonArray() {
        toJson("xml2json2/array.xml", "xml2json2/array.json");
    }
    ...
    public void testToXmlBasic() {
        toXml("xml2json2/basic.json", "xml2json2/basic.xml");
    }
    ...
    public void testToXmlAttrs() {
        toXml("xml2json2/attrs.json", "xml2json2/attrs.xml");
    }
    ...
    public void testToXmlElementWithAttrs() {
        toXml("xml2json2/element_attrs.json", "xml2json2/element_attrs.xml");
    }
    ...
    public void testToXmlElementWithAttrsMultiple() {
        toXml("xml2json2/element_attrs_multiple.json", "xml2json2/element_attrs_multiple.xml");
    }
    ...
    public void testToXmlCData() {
        toXml("xml2json2/cdata.json", "xml2json2/cdata.xml");
    }
    ...
    public void testToXmlCDataAttrs() {
        toXml("xml2json2/cdata_attrs.json", "xml2json2/cdata_attrs.xml");
    }
    ...
    public void testToXmlArray() {
        toXml("xml2json2/array.json", "xml2json2/array.xml");
    }
