...
public class Configuration {
    ...
    private static String[] getConfigParams() {
        List<String> staticParams = List.of("DIRIGIBLE_ANONYMOUS_USER_NAME_PROPERTY_NAME", "DIRIGIBLE_BRANDING_NAME",
                "DIRIGIBLE_BRANDING_BRAND", "DIRIGIBLE_BRANDING_FAVICON", "DIRIGIBLE_BRANDING_THEME", "DIRIGIBLE_BRANDING_KEY_PREFIX", "DIRIGIBLE_GIT_ROOT_FOLDER",
                "DIRIGIBLE_REGISTRY_EXTERNAL_FOLDER", "DIRIGIBLE_REGISTRY_IMPORT_WORKSPACE", "DIRIGIBLE_REPOSITORY_PROVIDER",
                "DIRIGIBLE_REPOSITORY_DATABASE_DATASOURCE_NAME", "DIRIGIBLE_MASTER_REPOSITORY_PROVIDER",
